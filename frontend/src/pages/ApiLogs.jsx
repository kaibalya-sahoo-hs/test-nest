...
const ApiLogs = () => {
  ...
  const fetchLogs = async () => {
    ...
    try {
      const response = await fetch("/admin/apiLogs", {
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-black text-white uppercase text-xs tracking-widest">
                  ...
                  <th className="p-4 border-r border-white/20 text-center">
                    Status
                  </th>
              ...
              <tbody className="font-mono text-sm">
                {isLoading ? (
                  <tr>
                    <td
                      colSpan="5"
                      className="p-20 text-center font-black animate-pulse uppercase"
                    >
                  ...
                  logs.map((log) => (
                    ...
                    >
                      <td className="p-4 border-r-2 border-black">
                        <span
                          className={`font-black px-2 py-1 border-2 rounded-md border-black shadow-[2px_2px_0px_0px_black]
                      ...
                      <td
                        className={`p-4 border-r-2 border-black text-center font-black text-lg ${getStatusColor(log.statusCode)}`}
                      >
                        {log.statusCode}
                      </td>
