...
function VendorProfile() {
  ...
  const fetchUser = async () => {
    try {
      ...
      const res = await api.get(`/vendor/${parsed.id}`);
  ...
  return (
    <div className="font-sans">
      <h1 className="text-xl sm:text-2xl font-bold text-[#202224] mb-4">
        My Profile
      </h1>
        ...
        <div className="pt-16 sm:pt-20 px-4 sm:px-8 pb-6 sm:pb-8">
          <div className="flex flex-col sm:flex-row items-start sm:justify-between gap-4 mb-6 sm:mb-8">
            <div>
              ...
              <button
                className="bg-blue-500 text-white p-2 my-2 rounded-xl text-md w-fit block cursor-pointer"
                onClick={() => navigate("/vendor/profile/wallet")}
              >
                Wallet
              </button>
            </div>
