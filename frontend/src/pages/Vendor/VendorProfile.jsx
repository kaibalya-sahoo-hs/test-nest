      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-50 overflow-hidden">
        ...
        <div className="relative h-28 sm:h-40 bg-gradient-to-r from-[#4379EE] to-[#6C9CFF]">
          <div className="absolute -bottom-12 sm:-bottom-16 left-4 sm:left-8">
            ...
            {isUploading && (
              <p className="text-xs text-[#4379EE] font-bold mt-2 animate-pulse text-center">Uploading...</p>
            )}
          </div>
        </div>
        ...
        <div className="pt-16 sm:pt-20 px-4 sm:px-8 pb-6 sm:pb-8">
          <div className="flex flex-col sm:flex-row items-start sm:justify-between gap-4 mb-6 sm:mb-8">
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-[#202224]">{user.name}</h2>
              <p className="text-gray-400 font-medium mt-1 text-sm sm:text-base break-all">{user.email}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="flex items-center gap-3 bg-[#F8F9FC] p-4 rounded-xl">
                  ...
                  <span className="text-sm font-semibold text-[#202224]">{user.name}</span>
                </div>
              </div>
              <div>
                ...
                <div className="flex items-center gap-3 bg-[#F8F9FC] p-4 rounded-xl">
                  ...
                  <span className="text-sm font-semibold text-[#202224]">{user.email}</span>
                </div>
              </div>
              <div>
                <label className="text-xs font-bold text-gray-400 uppercase tracking-wider block mb-2">Role</label>
                <div className="flex items-center gap-3 bg-[#F8F9FC] p-4 rounded-xl">
                  ...
                  <span className="text-sm font-semibold text-[#202224] capitalize">{user.role}</span>
                </div>
              </div>
              <div>
                <label className="text-xs font-bold text-gray-400 uppercase tracking-wider block mb-2">Account ID</label>
